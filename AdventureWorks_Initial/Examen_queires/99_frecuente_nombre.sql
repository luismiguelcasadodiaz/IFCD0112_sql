/*
¿Cual es el nombre (FirstName) más frecuente del subconjunto de los personas ([Person].[Person]) 
que tienen un nombre de 10 letras?

de La palabra más frecuente en el subconjunto de las palabras de longitud n, 
